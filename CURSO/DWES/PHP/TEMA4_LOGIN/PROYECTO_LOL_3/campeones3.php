...
echo "</thead>";
    ...
    foreach ($campeones as $campeon) { //Por cada campeón de la consulta realizada, mostrar cada campo en una nueva celda
        echo "<tr>";
            ...
            echo "<td>" . htmlspecialchars($campeon['id']) . "</td>";
            echo "<td>" . htmlspecialchars($campeon['nombre']) . " <span onclick=\"prueba()\" id=\"ordenarAsc\">↑</span> <span onclick=\"prueba()\" id=\"ordenarDesc\">↓</span> </td>";
...
<!--Estilo de las flechas de ordenación para distinguir cada una y darle interacción simple-->
<style>
